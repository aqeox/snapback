...
export const About = () => {
    return (
        <section className="text-center xl:text-left xl:grid grid-cols-2 xl:pb-20 flex flex-col items-center mx-10 max-w-7xl xl:m-auto">
                <section className=" md:flex md:flex-col xl:pr-32 md:max-w-xl">
                    ...
                    <button className="m-auto bg-gradient-to-r from-pink to bg-softPink rounded-lg px-10 py-6 sm:px-20 font-black text-white text-xl md:w-96">Claim CyberKongz NFTsnapback</button>
                </section>
